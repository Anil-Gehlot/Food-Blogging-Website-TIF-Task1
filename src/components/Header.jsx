...
export const Header = () => {
  return (
    <>
      ...
      <img src={redCurve} className="absolute top-0 lg:right-0 z-10"></img>
      ...
      <main className="w-9/12 lg:w-10/12 mx-auto">
        <section className="lg:w-[30%] lg:h-screen flex flex-col lg:mt-48 items-center lg:items-start text-center lg:text-left">
          <h1 className="font-source font-extrabold  text-4xl lg:text-6xl">
            Discover the <span className="text-pinkish">Best</span> Food and
            Drinks
          </h1>
          <p className="my-10 lg:w-11/12 text-[#444957] text-sm lg:text-base">
            Naturally made Healthcare Products for the better care & support of
            your body.
          </p>
          <button
            className={`bg-pinkish rounded-3xl w-40 h-12 text-white font-extrabold z-50 border`}
          >
            Explore Now!
          </button>
        </section>
